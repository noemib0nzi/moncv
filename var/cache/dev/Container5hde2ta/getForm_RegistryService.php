...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\LoisirType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\LoisirType']) ? $this->services['AppBundle\Form\LoisirType'] : $this->services['AppBundle\Form\LoisirType'] = new \AppBundle\Form\LoisirType()) && false ?: '_'};
